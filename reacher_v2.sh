#!/bin/bash
### train in the original environment, 
### with physical parameters in myrllib/envs/mujoco/assets/reacher_0.xml
echo -e "\nTrain the original environment in reacher_0.xml"
...
#######################################################################
echo -e "\nThe environment changes to a new one as reacher_2.xml..."
